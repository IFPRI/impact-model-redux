...
import MapChoro from '../utils/mapchoro'
...
export class Map extends React.Component {
  ...
  //
  //   this.uiCollections = ['mapChoro', 'dropdown', 'dropdown2', 'dropdown3']
  //   _.each(this.uiCollections, function (x) {
  //     this.listenTo(this.collection[x], 'sync', this.load)
  //   }.bind(this))
  //   this.listenTo(this.collection.mapChoro, 'reset', this.load)
  //   this.full = this.uiCollections.length
  //
  //   var that = this
  //
  //   this.spinner = new Spinner(IfpriImpact.spinnerOptions)
  //   this.mapTip = d3.tip()
  //     .attr('class', 'd3-tip')
  //     .offset(function (d) {
  ...
  // load () {
  //   this.loaded += 1
  //   if (this.loaded === this.full) {
  //     this.render()
  //   } else if (this.loaded > this.full) {
  //     this.drawMap()
  //   }
  // }
  //
