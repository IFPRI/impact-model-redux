      ...
      <div className='section__internal section__padding'>
        <div className='split-content'>
          <header className='header-internal'>
            ...
            <p className='internal__descriptions'>Newly added and most viewed Briefs are featured in the section below. Simply click on a Briefs to read more about a specific project and how the IMPACT.</p>
          </header>
